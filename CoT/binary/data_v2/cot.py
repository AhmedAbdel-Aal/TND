...
def cot_facts(facts, backend="deepseek"):
    response = llm_call(get_CoT_facts_prompt(facts), backend)
    return response


def cot_law(law, backend="deepseek"):
    response = llm_call(get_CoT_law_prompt(law), backend)
    return response


def cot_facts_law(facts, law, backend="deepseek"):
    response = llm_call(get_CoT_facts_law_prompt(facts, law), backend)
    return response
