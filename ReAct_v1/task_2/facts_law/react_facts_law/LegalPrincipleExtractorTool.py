...
from utils import load_json, from_input_path_to_output_path_for_cache
import os
...
class LegalPrincipleExtractor(BaseTool):
    ...
    def check_cache(self, file_path):
        ...
        output_file_path = from_input_path_to_output_path_for_cache(file_path)
        print(f"Checking cache for: {output_file_path}")
