...
## example usage
# example 3: python calc_metrics.py --results_dir ./results_facts_gpt4mini/
# example 4: python calc_metrics.py --results_dir ./results_facts_law_openai/


def map_classification(result):
    if "HIGH" in result:
        return 1
...
def get_metrics(mode="all"):
    ...
    for result in filtered_results:
        ...
        data.append(
            {
                #'id': result_data['id'],
                "classification": map_classification(result_data["result"]["output"]),
