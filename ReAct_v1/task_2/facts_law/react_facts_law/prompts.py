...
Final Answer: CLASSIFICATION: [HIGH IMPORTANCE, MEDIUM IMPORTANCE, LOW IMPORTANCE]
...
1. Use `facts_reader` to review the case facts
2. Use `law_reader` to review the case law and reasoning section.
3. Use `legal_principle_extractor` to identify core legal principles.
4. Use `citation_extractor` to analyze precedents.
5. Use `legal_helper` to ask specific legal questions about ECHR jurisprudence, building on extracted principles and citations.
