...
def check_cached_citation_results(file_path):
    # get output file path
    output_dir = "/Users/ahmed/Desktop/msc-24/TND/three_levels_classification/react_facts_law/results_facts_law_gpt4mini"
    processed_output_file_path = os.path.join(output_dir, file_path)
...
def run_workflow(list):
    ...
    for file_path in tqdm(list):
        ...
        print("Summarizing law.")
        law_summary = summarize_law(law)
        ...
        results = {
            "steps": {
                "summarize_facts": facts_summary,
                "summarize_law": law_summary,
