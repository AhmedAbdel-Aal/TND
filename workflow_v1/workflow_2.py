...
from llm import classify_four_levels_importance
...
def run_workflow(list):
    ...
    for file_path in tqdm(list):
        ...
        key_case_importance = classify_key_case_importance(inputs, file_path=file_path)
        three_levels_importance = classify_three_levels_importance(
            inputs, file_path=file_path
        )
        four_levels_importance = classify_four_levels_importance(inputs)
