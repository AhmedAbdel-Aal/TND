...
from prompts import ORCHESTRATOR_PROMPT, SYNTHESIZER_PROMPT_3c, WORKER_PROMPT
...
output_dir = "/Users/ahmed/Desktop/msc-24/TND/key_case_binary_classification/pre_cutoff_analysis/orchestrator/results_facts_law_3c"
    ...
    for file_path in tqdm(list):
        ...
        try:
            ...
            orchestrator = FlexibleOrchestrator(
                ...
                synthetizer_prompt=SYNTHESIZER_PROMPT_3c,
            ...
            results = orchestrator.process(
                task=f"""
Analyze the provided case facts and law section, then classify the case importance into one of the following categorie:

HIGH:
- All judgments, decisions and advisory opinions not included in the Case Reports which make a significant contribution to the development, clarification or modification of its case-law, either generally or in relation to a particular State.

MEDIUM:
- Other judgments, decisions and advisory opinions which, while not making a significant contribution to the case-law, nevertheless go beyond merely applying existing case-law.
...
Based on the facts and law provided, classify the case importance into one of the classes [HIGH , MEDIUM, LOW]. Your decision should be based strictly on the criteria above.
            """
            )
