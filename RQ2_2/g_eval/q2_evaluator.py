...
class Q2Evaluator:
    ...
    def init_classify(
        ...
        user_prompt = f"""
            ...
            1. Read the actual law section and identify the factual circumstances
            2. Read the generated law section and compare it to the actual law section. Check if the generated reasoning covers all the factual circumstances.
