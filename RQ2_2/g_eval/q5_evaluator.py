...
class Q5Evaluator:
    ...
    def init_classify(
        ...
        user_prompt = f"""
            ...
            - Grounding facts in correct legal precedence

            Evaluation Steps:

            1. Read the actual law section then identify how the facts are grounded in the correct legal precedence.
            2. Read the generated law section and check for how the facts are grounded in the correct legal precedence.
