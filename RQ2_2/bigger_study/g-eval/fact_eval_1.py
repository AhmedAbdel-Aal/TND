...
class FactFabricationCheckAgent:
    ...
    def _generate(
        ...
        user_prompt = f"""
            please read the two documents about facts of a legal case and determine if there is a fact in the second document that was never mentioned in the first.
            ...
            "There is invented fact: <explain and mention the new fact>" or "There is no invented facts in the second document"
         """
        # print(user_prompt)
