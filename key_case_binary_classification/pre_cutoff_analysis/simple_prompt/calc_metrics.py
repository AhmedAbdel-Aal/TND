...
## example usage
# example 1: python calc_metrics.py --results_dir ./results_facts_haiku/
# example 2: python calc_metrics.py --results_dir ./results_facts_law_haiku/
# example 3: python calc_metrics.py --results_dir ./results_facts_openai/
# example 4: python calc_metrics.py --results_dir ./results_facts_law_openai/
        ...
        data.append(
            {
                ...
                "classification": return_binary_classification(
                    result_data["result"]["classification"]
                ),
