...
class ImpAgent:
    ...
    def init_classify(self, source_text, system_message="You are a helpful assistant."):
        ...
        user_prompt = f"""
            Please given a set of questions and answers about case, classify a case into one of three categories of importance: [High, Medium, Low].
            ...
            The set of questions and answer about the case is delimited by XML tags <QA></QA> as follows:
